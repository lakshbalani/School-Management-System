 ...
 * @author laksh
 */
public class fne_stu extends javax.swing.JFrame {

    /**
     * Creates new form fne_stu
     */
    public fne_stu() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String fname= sfn.getText();
        String mname= smn.getText();
        String cl= sc.getText();
        String rn= srn.getText();
        ...
        try{
            ...
            String sql = "update `Students` SET `fname`='"+fname+"',`mname`='"+mname+"',`name`='"+name+"',`class`='"+cl+"',`roll`='"+rn+"',`address`='"+add+"',`mobile`='"+mob+"'WHERE id = '"+id+"'";
            PreparedStatement ps= conn.prepareStatement(sql);
            ps.execute();
            
            JOptionPane.showMessageDialog(null, "Record has been updated successfully for the entered id!");
        }
        catch(Exception e)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fne_stu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
